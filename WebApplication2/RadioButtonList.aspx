<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListView.aspx.cs" Inherits="WebApplication2.ListView" %>
...
<body>
    <form id="form1" runat="server">
        <div>
           <h4>Your Hobby: </h4> 
            <asp:RadioButtonList ID="RadioButtonList" runat="server" RepeatLayout="Flow" RepeatColumns="2">
